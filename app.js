(function () {
  ...
  var CONSENT_TEXT_REQUIRED =
    ...
    "<p>엠키스코어-HPE가 귀하의 개인정보를 수집, 이용하는 목적은 다음과 같습니다. 제품과 서비스에 대해 귀하와의 연락, 고객 서비스 증진, 제품 및 서비스에 대한 정보 제공 및 판매, 새로운 서비스와 혜택에 대한 업데이트, 개별 프로모션 제안, 제품 및 서비스에 대한 시장 조사.</p>" +
    ...
    "<p><strong>4. 동의를 거부할 권리 및 동의 거부에 따른 불이익</strong><br>귀하는 위 개인정보의 수집, 이용에 대한 동의를 거부할 수 있으며, 동의를 거부한 경우에는 엠키스코어-HPE는 귀하에게 그와 관련된 정보나 혜택을 제공하지 않게 됩니다.</p>";

  var CONSENT_TEXT_OPTIONAL =
    "<strong>전화, E-mail, SMS 수신 동의</strong>" +
    "<p>엠키스코어-HPE는 제품 및 서비스, 프로모션 또는 시장조사 등의 유용한 정보를 온라인과 오프라인을 통해 안내 드리고자 합니다. 기프트 제공 또는 기프티콘 발송을 위해 전화 연락 또는 SMS 발송을 드릴 수 있습니다.</p>";
